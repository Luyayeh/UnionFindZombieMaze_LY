...
public class Maze 
{
    ...
    public void moveZombie()
    {
        ...
        {
            boolean next = false;
            int randIndex, row_move, col_move;
         
            do
            {
                randIndex = (int) (Math.random() * move.length);
                row_move = move[randIndex][0];
                col_move = move[randIndex][1];
                ...
                if(((z_row + row_move) >= 0) && (z_row + row_move) < (exit_row + 1) && (z_col + col_move) >= 0 && (z_col + col_move) < (exit_col + 1))
                {
                    ...
                    {
//                         && (z_row != map_row || z_col != map_col) && (z_row != exit_row && z_col != exit_col) && (z_row != 0 && z_col != 0)
                        if((z_row == 0 && z_col == 0) || (z_row == map_row && z_col == map_col) || (z_row == exit_row && z_col == exit_col))
                        {
                            next = false;
                        }
//                        else if(row_move == 0 && col_move == 0)
//                        {
